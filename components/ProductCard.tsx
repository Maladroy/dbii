...
function ProductCard({ product, onClick, onOpenContact }: ProductCardProps) {
    ...
    return (
        <div
            ...
            className={`bg-white rounded-xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col group overflow-hidden cursor-pointer relative ${isCombo ? 'border-2 border-yellow-400' : 'border border-gray-100'
                }`}
        >
            {isCombo && (
