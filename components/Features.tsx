...
function Features({ onOpenStory }: FeaturesProps) {
    return (
                        ...
                        {CORE_VALUES.map((value, idx) => {
                            ...
                            return (
                                <div key={idx} className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 text-center group relative overflow-hidden">
                                    <div className="absolute top-0 left-0 w-full h-1 bg-linear-to-r from-blue-400 to-blue-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></div>
