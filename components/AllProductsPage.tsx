...
function AllProductsPage({ onBack, onProductClick, onOpenContact }: AllProductsPageProps) {
              ...
              {CATEGORIES.map(cat => (
                <li key={cat}>
                  <button
                    ...
                    className={`w-full text-left px-4 py-2 rounded-lg transition-colors flex justify-between items-center ${activeCategory === cat
            ...
            <div className="flex flex-wrap gap-2">
              {CATEGORIES.map(cat => (
                <button
                  ...
                  className={`px-3 py-1.5 text-xs rounded-full border ${activeCategory === cat
