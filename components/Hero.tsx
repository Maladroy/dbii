  ...
  return (
    <section id="home" className="container mx-auto px-4 py-6 scroll-mt-24">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        {/* Main Slider */}
        <div className="lg:col-span-2 relative group rounded-2xl overflow-hidden shadow-md h-[200px] md:h-[350px] lg:h-[420px]">
          <div 
            ...
            {HERO_BANNERS.map((_, index) => (
              <button
                ...
                className={`w-2 h-2 md:w-3 md:h-3 rounded-full transition-all ${
                  currentSlide === index ? 'bg-white w-6 md:w-8' : 'bg-white/50 hover:bg-white'
                }`}
              />
            ))}
          </div>
        ...
        {/* Side Banners */}
        <div className="hidden lg:flex flex-col gap-4 h-[420px]">
